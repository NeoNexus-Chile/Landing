...
export default function Header() {
  return (
    <header
      id="home"
      className="grid grid-cols-[2fr_3fr] min-h-svh isolate relative"
    >
      <div className="bg-neutral-950 clip-path-header relative flex flex-col justify-center items-center text-white gap-12 overflow-hidden group">
        ...
        />
        <div className="bg-neutral-950/75 z-10 py-14 px-8 w-full clip-path-mision pl-28 -mr-[20%] transition-all duration-300 group-hover:translate-x-full">
          <p className="text-4xl font-bold">El nexo entre ideas</p>
          <p className="text-4xl font-thin opacity-75">
            Y realidades digitales.
          </p>
        </div>
        <img
          className="absolute inset-0 h-full w-full opacity-50 object-cover pointer-events-none transition-all duration-300 group-hover:scale-[2]"
          src="/assets/header-bg.webp"
          alt="Fondo de colores"
        />
      </div>
      <article className="p-16 text-center flex flex-col justify-center mt-16">
        <h1 className="text-7xl mb-8 leading-9 font-regular">
          Transformamos ideas
          <br />
