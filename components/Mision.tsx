      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr]">
        <div className="relative">
          <img
            ...
            className="object-contain relative mt-1 lg:mt-8 -ml-8 lg:-right-20 2xl:-right-32 pointer-events-none"
          />
          <div className="absolute lg:hidden w-full bg-white -bottom-8 z-20 left-0 h-8 rounded-b-[100%]"></div>
        </div>

        <article className="bg-[#1C5870] h-fit text-white text-lg lg:text-xl text-center lg:text-right flex flex-col items-center lg:items-end gap-16 clip-path-mision lg:pl-32 pl-4 pr-4 pt-16 pb-16 lg:py-16 lg:pr-28 lg:mt-20 relative">
          ...
          <img
            ...
            className="absolute bottom-0 scale-125 lg:scale-100 lg:-top-14 2xl:-top-24 left-0 w-full object-cover object-top -z-10 opacity-[0.1]"
          />
        </article>
      </div>
    </section>
